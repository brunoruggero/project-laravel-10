                        ...
                        @foreach ($supports->items() as $support)
                            <tr>
                                ...
                                <td class="px-4 py-2 text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">
                                    {{ substr($support->description, 0,30)  }}...
                                </td>
                                ...
                                <td class="px-4 py-2 text-sm whitespace-nowrap flex">
                                    ...
                                    <span class="px-1 py-1 text-gray-500 transition-colors duration-200 rounded-lg">|</span>
                                    ...
                                    <form action="{{ route('supports.destroy', $support->id) }}" method="post">
                                        @csrf()
                                        @method('DELETE')
                                        <button type="submit" class="px-1 py-1 text-gray-500 transition-colors duration-200 rounded-lg">Deletar</button>
                                    </form>
                                </td>
                            </tr>
                        @endforeach
